...
import hero from "../assets/projekte/lernhaus_still.jpg";
...
<figure class="layout-grid">
  <Image
    ...
    alt="Ein Schüler sitzt in einem großen offenen Raum und schreibt. Hinter ihm auf einem großen gelben Teppich ein Turm aus Holzbausteinen, mit denen er vieleicht gerade noch gespielt hat. In der Tiefe des Raumes weitere SchülerInnen die sich konzentriert beschäftigen."
  />
  <figcaption>
    Architektur und Schulentwicklung. Szene in einem Lernhaus der Grundschule
    Bauhausplatz (Foto: Franz Kastner)
  </figcaption>
</figure>
...
- 2004-21 [Zur Ortsgeschichte des Marktes Oberstdorf](/oberstdorf), Zeitzeugen-Interviewprojekt
